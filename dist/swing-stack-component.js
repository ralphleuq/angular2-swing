...
var SwingStackComponent = (function () {
    ...
    SwingStackComponent.prototype.addCard = function (card, prepend) {
    ...
    SwingStackComponent.prototype.ngAfterContentInit = function () {
        ...
        // Hook various events
        this.stack.on('throwout', function ($event) { return _this.throwoutup.emit($event); });
        this.stack.on('throwoutend', function ($event) { return _this.throwoutup.emit($event); });
        this.stack.on('throwoutleft', function ($event) {
            _this.throwoutup.emit($event);
            console.log($event);
        });
        this.stack.on('throwoutright', function ($event) { return _this.throwoutup.emit($event); });
        this.stack.on('throwin', function ($event) { return _this.throwin.emit($event); });
        this.stack.on('throwinend', function ($event) { return _this.throwoutup.emit($event); });
        ...
        this.stack.on('throwoutdown', function ($event) { return _this.throwoutup.emit($event); });
    };
